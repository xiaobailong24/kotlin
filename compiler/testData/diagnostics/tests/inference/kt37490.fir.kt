...
fun nullTypeArg(invP: SomeGene<Any>, inP: SomeGene<in Any>, outP: SomeGene<out Any>) {
    ...
    inP.setFace(null) // NULL_FOR_NONNULL_TYPE: Null can not be a value of a non-null type Nothing
    inP.setString(null) // no error
    outP.setFace(null) // NULL_FOR_NONNULL_TYPE: Null can not be a value of a non-null type Nothing
