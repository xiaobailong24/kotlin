...
internal fun createSimplePSICallArgument(
    ...
    val te = if (ktExpression is KtCallableReferenceExpression) ktExpression.callableReference else ktExpression

    val partiallyResolvedCall = te.getCall(bindingContext)?.let {
