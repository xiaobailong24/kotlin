...
class ResolvedAtomCompleter(
    ...
    private fun complete(resolvedAtom: ResolvedAtom) {
        ...
        when (resolvedAtom) {
            ...
            is CallableReferenceResolvedArgumentAtom -> completeCallableReferenceArgument(resolvedAtom)
    ...
    private fun completeSubCallArgument(resolvedSubCallArgument: ResolvedSubCallArgument) {
        ...
        if (deparenthesizedExpression is KtCallableReferenceExpression) {
            completeCallableReferenceCall(
                kotlinToResolvedCallTransformer.getResolvedCallForArgumentExpression(
    ...
    private fun updateCallableReferenceResultType(
        ...
        val freshSubstitutor = callableCandidate.freshSubstitutor ?: return null
    ...
    fun completeCallableReferenceCall(resolvedCall: NewCallableReferenceResolvedCall<*>): KotlinType? {
        val atom = resolvedCall.resolvedCallAtom ?: return null
        val callableReferenceExpression = resolvedCall.psiKotlinCall.psiCall.callElement.parent as? KtCallableReferenceExpression
            ?: return null
    ...
    fun completeCallableReferenceArgument(resolvedAtom: CallableReferenceResolvedArgumentAtom): KotlinType? {
        ...
        return completeCallableReference(callableReferenceExpression, candidate, descriptor, dataFlowInfo) {
            NewCallableReferenceResolvedCall<CallableDescriptor>(resolvedAtom, typeApproximator, null)
