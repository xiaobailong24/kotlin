...
class ResolvedAtomCompleter(
    ...
    private fun updateCallableReferenceResultType(callableCandidate: CallableReferenceCallCandidate): CallableReferenceResultTypeInfo? {
    ...
    private fun extractCallableReferenceResultTypeInfoFromDescriptor(
        callableCandidate: CallableReferenceCallCandidate,
