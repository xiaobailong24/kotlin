...
class DoubleColonExpressionResolver(
    ...
    internal fun bindFunctionReference(
        ...
        val ap = context.trace.get(BindingContext.FUNCTION, expression)
    ...
    private fun tryResolveRHSWithReceiver(
        ...
        val resolutionResults = callResolver.resolveCallForMember(
            reference, BasicCallResolutionContext.create(newContext.replaceCallPosition(CallPosition.CallableReferenceRhs(lhs)), call, CheckArgumentTypesMode.CHECK_CALLABLE_TYPE)
        )
