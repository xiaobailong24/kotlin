...
interface IrDeclarationOrigin {
    ...
    object ADAPTER_FOR_NON_SUSPEND_CONVERSION : IrDeclarationOriginImpl("ADAPTER_FOR_NON_SUSPEND_CONVERSION", isSynthetic = true)
    object ADAPTER_PARAMETER_FOR_NON_SUSPEND_CONVERSION : IrDeclarationOriginImpl("ADAPTER_PARAMETER_FOR_NON_SUSPEND_CONVERSION")
