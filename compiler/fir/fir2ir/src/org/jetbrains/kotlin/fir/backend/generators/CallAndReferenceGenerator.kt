...
class CallAndReferenceGenerator(
    ...
    private fun IrMemberAccessExpression<*>.putContextReceiverArguments(statement: FirStatement?): Int {
        val contextReceiverCount = (statement as? FirContextReceiverArgumentListOwner)?.contextReceiverArguments?.size ?: 0
        if (statement is FirContextReceiverArgumentListOwner && contextReceiverCount > 0) {
