...
object FirUnderscoredTypeArgumentSyntaxChecker : FirExpressionSyntaxChecker<FirFunctionCall, PsiElement>() {
    override fun isApplicable(element: FirFunctionCall, source: FirSourceElement): Boolean =
    ...
    override fun checkPsi(
        ...
        for (typeProjection in element.typeArguments) {
            ...
            for (annotation in typeReference.annotationEntries) {
                reporter.reportOn(
                    annotation.toFirPsiSourceElement(), FirErrors.UNSUPPORTED,
    ...
    override fun checkLightTree(
        ...
        if (source !is FirLightSourceElement) return
