...
class CallableReferenceNotCompatible(
    ...
    override fun report(reporter: DiagnosticReporter) {
        when (argument) {
            is CallableReferenceKotlinCall ->
...
class NoneCallableReferenceCallCandidates(override val argument: CallableReferenceKotlinCallArgument) : InapplicableArgumentDiagnostic()

class CallableReferenceCallCandidatesAmbiguity(
    override val argument: CallableReferenceKotlinCallArgument,
    val candidates: Collection<CallableReferenceCallCandidate>
) : InapplicableArgumentDiagnostic()
...
class ManyCandidatesCallDiagnostic(val candidates: Collection<CallCandidate>) : KotlinCallDiagnostic(INAPPLICABLE) {
    override fun report(reporter: DiagnosticReporter) {
        reporter.onCall(this)
    }
}
