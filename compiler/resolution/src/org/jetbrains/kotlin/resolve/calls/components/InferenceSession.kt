...
interface InferenceSession {
    ...
    companion object {
        val default = object : InferenceSession {
            ...
            override fun shouldRunCompletion(candidate: CallCandidate): Boolean = true
    ...
    fun shouldRunCompletion(candidate: CallCandidate): Boolean
    ...
    fun computeCompletionMode(candidate: CallCandidate): ConstraintSystemCompletionMode?
