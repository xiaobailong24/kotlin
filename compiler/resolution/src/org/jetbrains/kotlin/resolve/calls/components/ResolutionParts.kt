...
internal object CheckVisibility : ResolutionPart() {
    override fun CallCandidate.process(workIndex: Int) {
...
internal object CheckExplicitReceiverKindConsistency : ResolutionPart() {
    private fun CallCandidate.hasError(): Nothing =
        error(
...
private fun CallCandidate.resolveKotlinArgument(
...
private fun CallCandidate.shouldRunConversionForConstants(expectedType: UnwrappedType): Boolean {
...
private fun CallCandidate.checkUnsafeImplicitInvokeAfterSafeCall(argument: SimpleKotlinCallArgument): ImplicitInvokeCheckStatus {
...
private fun CallCandidate.prepareExpectedType(expectedType: UnwrappedType): UnwrappedType {
...
internal object CheckReceivers : ResolutionPart() {
    private fun CallCandidate.checkReceiver(
...
//        }
    ...
    override fun CallCandidate.workCount() = 2
}
...
internal object CheckArgumentsInParenthesis : ResolutionPart() {
    ...
    override fun CallCandidate.workCount() = kotlinCall.argumentsInParenthesis.size
}
...
internal object EagerResolveOfCallableReferences : ResolutionPart() {
    override fun CallCandidate.process(workIndex: Int) {
        getSubResolvedAtoms()
            ...
            .forEach {
                callComponents.callableReferenceArgumentResolver.processCallableReferenceArgument(getSystem(), it, this, resolutionCallbacks)
            }
    }
}
...
internal object CheckCallableReference : ResolutionPart() {
    override fun CallCandidate.process(workIndex: Int) {
        if (this !is CallableReferenceCallCandidate) {
