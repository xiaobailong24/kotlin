...
abstract class ResolutionPart {
    abstract fun CallCandidate.process(workIndex: Int)

    open fun CallCandidate.workCount(): Int = 1

    // helper functions
    protected inline val CallCandidate.candidateDescriptor get() = resolvedCall.candidateDescriptor
    protected inline val CallCandidate.kotlinCall get() = resolvedCall.atom
}
...
class ResolvedCallableReferenceCallAtom(
    ...
    candidate: CallableReferenceCallCandidate? = null
...
open class MutableResolvedCallAtom(
    ...
    open val candidate: CallableReferenceCallCandidate? = null
) : ResolvedCallAtom() {
...
fun CallCandidate.markCandidateForCompatibilityResolve() {
