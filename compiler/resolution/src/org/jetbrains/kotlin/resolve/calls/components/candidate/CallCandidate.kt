...
sealed class CallCandidate : Candidate, KotlinDiagnosticsHolder {
    ...
    abstract val variableCandidateIfInvoke: CallCandidate?
    ...
    override fun addCompatibilityWarning(other: Candidate) {
        if (other is CallCandidate && this !== other && this::class == other::class) {
