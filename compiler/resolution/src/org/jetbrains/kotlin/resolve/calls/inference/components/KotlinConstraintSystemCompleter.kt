...
class KotlinConstraintSystemCompleter(
    ...
    private fun ConstraintSystemCompletionContext.tryToCompleteWithBuilderInference(
        ...
        val dontUseBuilderInferenceIfPossible = languageVersionSettings.supportsFeature(LanguageFeature.DontUseBuilderInferenceIfPossible)
        ...
        if (!dontUseBuilderInferenceIfPossible) return false
    ...
    private fun ConstraintSystemCompletionContext.analyzeArgumentWithFixedParameterTypes(
        ...
        val dontUseBuilderInferenceIfPossible = languageVersionSettings.supportsFeature(LanguageFeature.DontUseBuilderInferenceIfPossible)
        val argumentToAnalyze = if (!dontUseBuilderInferenceIfPossible) {
