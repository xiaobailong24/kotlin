...
class CallableReferenceResolver(
    ...
    fun processCallableReferenceArgument(
        ...
        val candidates = resolutionCallbacks.resolveCallableReference(
            ...
            baseSystem,
            diagnosticsHolder,
            argument = resolvedAtom.atom
        ) as Collection<CallableReferenceCandidate>
        ...
        if (chosenCandidate != null) {
            val (toFreshSubstitutor, diagnostic) = with(chosenCandidate) {
                csBuilder.checkCallableReference(
                    ...
                    reflectionCandidateType, expectedType, scopeTower.lexicalScope.ownerDescriptor, argument = argument
                )
            }
