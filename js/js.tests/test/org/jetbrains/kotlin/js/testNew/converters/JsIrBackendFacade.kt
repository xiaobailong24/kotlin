    ...
    override fun transform(module: TestModule, inputArtifact: IrBackendInput): BinaryArtifacts.Js? {
        ...
        if (isMainModule) {
            ...
            val compiledModule = compileIr(
                ...
                generateFullJs = true,
                generateDceJs = if (runIrPir) false else runIrDce,
                dceDriven = runIrPir,
                ...
                lowerPerModule = if (runIrPir) false else lowerPerModule,
            ...
            return BinaryArtifacts.JsIrArtifact(outputFile, compiledModule)
        } else {
