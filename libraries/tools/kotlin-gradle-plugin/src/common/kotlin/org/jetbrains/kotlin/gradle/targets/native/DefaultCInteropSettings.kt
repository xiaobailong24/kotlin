...
import org.jetbrains.kotlin.gradle.plugin.mpp.pm20.KpmNativeVariantCompilationData
...
private fun KotlinNativeCompilationData<*>.disambiguateName(simpleName: String): String = when (this) {
    ...
    is KpmNativeVariantCompilationData -> owner.disambiguateName(simpleName)
